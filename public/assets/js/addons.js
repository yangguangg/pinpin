...
if (Config.modulename == 'admin' && Config.controllername == 'index' && Config.actionname == 'index') {
    ...
    require(['vue', 'jquery', 'chat', 'text!../addons/shopro/chat.html', 'ELEMENT'], function (Vue, $, Chat, ChatTemp, ELEMENT) {
        ...
        Fast.api.ajax({
            ...
            if (res.data.config.type == 'shopro') {
                ...
                wsUri = wg+'://' + window.location.host +':' + res.data.config.system.gateway_port;
